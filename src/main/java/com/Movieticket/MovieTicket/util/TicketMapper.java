...
public class TicketMapper {
    ...
    public Ticket maptoTicket(TicketDTO ticketDTO){
        Optional<Seat> seat = seatRepo.findById(ticketDTO.getSeat_id());
        Optional<Shows> show = showsRepo.findById(ticketDTO.getShow_id());
        ...
        if (
            ...
            Ticket ticket = new Ticket(
                    ...
                    cinema_hall.get().getCineHallName(),
                    movie.get().getMovieName(),
                    theater.get().getTheaterId(),
                    ticketDTO.getShow_id(),
